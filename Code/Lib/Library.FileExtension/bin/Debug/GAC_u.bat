...
@echo
@echo del Library.DialogDebugger
 del /q "C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\Packages\Debugger\Visualizers"\Library.DialogDebugger.dll 
