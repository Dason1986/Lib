using Library.FileExtension.ExcelDataReader.Exceptions;
using System;
...
{
    /// <summary>
    /// Represents Library.FileExtension.ExcelDataReader file header
    /// </summary>
    internal class XlsHeader
    {
        ...
        /// <summary>
        /// Transaction signature, 0 for Library.FileExtension.ExcelDataReader
        /// </summary>
        ...
        /// <summary>
        /// Reads Library.FileExtension.ExcelDataReader header from Stream
        /// </summary>
        /// <param name="file">Stream with Library.FileExtension.ExcelDataReader file</param>
